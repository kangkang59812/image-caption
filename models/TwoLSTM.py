...
class DecoderWithAttention(nn.Module):
    ...
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, features_dim=196, dropout=0.5):
        """
        ...
        self.top_down_attention = nn.LSTMCell(
            embed_dim + features_dim + decoder_dim, decoder_dim, bias=True)  # top down attention LSTMCell
        self.language_model = nn.LSTMCell(
            features_dim + decoder_dim, decoder_dim, bias=True)  # language model LSTMCell
